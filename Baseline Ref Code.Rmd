...
predict_total_df <- predict_total_df %>% 
  rename("total_acres" = predict_total_run)
...
predict_annual_df <- predict_annual_df %>% 
  rename("annual_row" = predict_annual_run)
...
predict_orchard_df <- predict_orchard_df %>% 
  rename("orchard" = predict_orchard_run)
...
predict_vineyard_df <- predict_vineyard_df %>% 
  rename("vineyard" = predict_vineyard_run)
...
predict_pasture_df <- predict_pasture_df %>% 
  rename("pasture" = predict_pasture_run)
...
ggplot() + 
  ...
  geom_line(data = predict_total_df, aes(x = year, y = total_acres))
```
